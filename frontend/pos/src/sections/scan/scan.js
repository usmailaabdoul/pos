        ...
        <div>
          ...
          <div id="print">
            <div className="text-center mb-2">
              ...
              <span>Scan report: {startDate.toLocaleDateString()} - {endDate.toLocaleTimeString()}</span>
            </div>
              ...
              <tbody>
                {scanData.map((scan, i) => {
                  return <tr key={i}>
                    ...
                    <td>{scan.qty}</td>
                    <td>{scan.total}</td>
                    <td>{scan.retailPrice}</td>
                    <td>{scan.discount}</td>
                    <td>{scan.isWholeSale ? 'Yes' : 'No'}</td>
                  </tr>
                })}
              </tbody>
            </table>
